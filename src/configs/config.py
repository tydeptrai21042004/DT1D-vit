...
_C.MODEL.ADAPTER.NAME = "none"  # "WHC_DT1D", "DT1D", "Pfeiffer", or "none"
...
# Final WHC-Compact-DT1D proposal for ViT patch-token grids.
_C.MODEL.ADAPTER.WHC_DT1D = CfgNode()
_C.MODEL.ADAPTER.WHC_DT1D.AXIS = "hw"
_C.MODEL.ADAPTER.WHC_DT1D.GROUP_SIZE = 16
_C.MODEL.ADAPTER.WHC_DT1D.ACTIVE_OFFSETS = "1,2,4"
_C.MODEL.ADAPTER.WHC_DT1D.DETAIL_BASIS = "orth"
_C.MODEL.ADAPTER.WHC_DT1D.DETAIL_COMPONENTS = "offset4"
_C.MODEL.ADAPTER.WHC_DT1D.CONTRAST_SPLIT = 8
_C.MODEL.ADAPTER.WHC_DT1D.PROJECT_L1 = True
_C.MODEL.ADAPTER.WHC_DT1D.GATE_MODE = "fixed"
_C.MODEL.ADAPTER.WHC_DT1D.GATE_INIT = 0.01
_C.MODEL.ADAPTER.WHC_DT1D.RESIDUAL_SCALE = 1.0
_C.MODEL.ADAPTER.WHC_DT1D.PADDING = "replicate"
_C.MODEL.ADAPTER.WHC_DT1D.USE_POINTWISE = False
_C.MODEL.ADAPTER.WHC_DT1D.POINTWISE_RATIO = 32
_C.MODEL.ADAPTER.WHC_DT1D.POINTWISE_GROUPS = 4
_C.MODEL.ADAPTER.WHC_DT1D.USE_BN = False
_C.MODEL.ADAPTER.WHC_DT1D.CACHE_KERNEL = False
_C.MODEL.ADAPTER.WHC_DT1D.P = 2
_C.MODEL.ADAPTER.WHC_DT1D.LAMBDA_MODE = "learned"
_C.MODEL.ADAPTER.WHC_DT1D.LAMBDA_SCOPE = "block"
_C.MODEL.ADAPTER.WHC_DT1D.LAMBDA_INIT = 0.0
_C.MODEL.ADAPTER.WHC_DT1D.LAMBDA_MAX = 0.5
_C.MODEL.ADAPTER.WHC_DT1D.SHIFT_NORMALIZATION = "mean"
# ----------------------------------------------------------------------
