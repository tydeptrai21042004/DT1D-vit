#!/usr/bin/env python3
"""Run the reviewer-driven WHC-p2 ViT ablation manifest through train.py."""
...
def main():
    ...
    ap.add_argument("--base-config", default="configs/finetune/flowers_whc_dt1d.yaml")
    ap.add_argument("--manifest", default="configs/ablations/whc_p2_fixed_gate_vit.yaml")
    ap.add_argument("--output-root", default="outputs/whc_p2_vit_ablation")
