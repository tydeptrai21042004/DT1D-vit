...
DATASETS = {
    ...
    "vtab-caltech101": {
        ...
        "classes": 102,
        "default_batches": (32,),
        # Preserve the manuscript's existing VPT parameter budget (10 tokens,
        # ~86,118 trainable params). The supplied source ZIP does not contain
        # the separately distributed dataset-specific VTAB hyperparameter file,
        # so this value is manuscript-defined rather than claimed as source-derived.
        "vpt_tokens": 10,
    ...
    if method == "vpt":
        return {
            "MODEL": {
                ...
                "ADAPTER": {"NAME": "none"},
                # Explicitly mirror the supplied original VPT shallow-prompt
                # defaults instead of relying on repository defaults.
                "PROMPT": {
